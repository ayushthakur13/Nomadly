...
const Dashboard = () => {
  ...
  const quickActions = [
    { icon: "✈️", title: "Create New Trip", description: "Start planning your next adventure", action: () => navigate('/trips'), color: "bg-emerald-500" },
    { icon: "🗺️", title: "View My Trips", description: "Manage your existing trips", action: () => navigate('/trips'), color: "bg-blue-500" },
    { icon: "🧭", title: "Explore Trips", description: "Discover popular destinations", action: () => navigate('/explore'), color: "bg-purple-500" },
  ];
